     ...
     AUI().ready('aui-node',function(A) {
      A.all('#criteria-list option:selected').each(function() {
        ...
        if(x==96501)
        {
         ...
         var y =  A.one('#<portlet:namespace/>criteria-list option:selected').text();
        A.one('#fieldsselected').append('<li type="none">'+y+'</li>');
...
<%	 
  ...
  PimReports pimReports = (PimReports)portletSession.getAttribute("pimreportRecord");
...
<div class="span4">
<aui:input name="reportName" value="<%=pimReports.getReportName()%>" id="reportName" label="" inlineLabel="left" showRequiredLabel="false"><aui:validator name="required" errorMessage="Report Name Required"></aui:validator> </aui:input>
<aui:input name="reportId" type="hidden" value="<%=pimReports.getReportId()%>"></aui:input>
...
<div class="span4">
<% 
 if(pimReports.getInclude().equals("Current Employees Only")){
%>
<aui:select name="includeEmployees" label="" id="status">
<aui:option value="Current Employees Only" selected="true">Current Employees Only</aui:option>
...
if(pimReports.getInclude().equals("Current and Past Employees")){
%>

<aui:select name="includeEmployees" label="" id="status">
<aui:option value="Current Employees Only" >Current Employees Only</aui:option>
<aui:option value="Current and Past Employees" selected="true">Current and Past Employees</aui:option>
<aui:option value="Past Employees Only">Past Employees Only</aui:option>
</aui:select>
<%
  }
if(pimReports.getInclude().equals("Past Employees Only")){
%>
<aui:select name="includeEmployees" label="" id="status">
<aui:option value="Current Employees Only" >Current Employees Only</aui:option>
<aui:option value="Current and Past Employees" >Current and Past Employees</aui:option>
<aui:option value="Past Employees Only" selected="true">Past Employees Only</aui:option>
</aui:select>
<%
  }
%>

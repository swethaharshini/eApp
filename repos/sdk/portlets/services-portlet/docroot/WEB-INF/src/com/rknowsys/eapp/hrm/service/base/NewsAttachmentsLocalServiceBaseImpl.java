...
import com.rknowsys.eapp.hrm.service.NewsAttachmentsLocalService;
...
/**
 * Provides the base implementation for the news attachments local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.NewsAttachmentsLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.NewsAttachmentsLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.NewsAttachmentsLocalServiceUtil
 * @generated
 */
public abstract class NewsAttachmentsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NewsAttachmentsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.NewsAttachmentsLocalServiceUtil} to access the news attachments local service.
	 */

	/**
	 * Adds the news attachments to the database. Also notifies the appropriate model listeners.
	 *
	 * @param newsAttachments the news attachments
	 * @return the news attachments that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NewsAttachments addNewsAttachments(NewsAttachments newsAttachments)
		throws SystemException {
		newsAttachments.setNew(true);

		return newsAttachmentsPersistence.update(newsAttachments);
	}
	 ...
	 */
	@Override
	public NewsAttachments createNewsAttachments(long newsAttachmentId) {
		return newsAttachmentsPersistence.create(newsAttachmentId);
	}

	/**
	 * Deletes the news attachments with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param newsAttachmentId the primary key of the news attachments
	 * @return the news attachments that was removed
	 * @throws PortalException if a news attachments with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public NewsAttachments deleteNewsAttachments(long newsAttachmentId)
		throws PortalException, SystemException {
		return newsAttachmentsPersistence.remove(newsAttachmentId);
	}

	/**
	 * Deletes the news attachments from the database. Also notifies the appropriate model listeners.
	 *
	 * @param newsAttachments the news attachments
	 * @return the news attachments that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public NewsAttachments deleteNewsAttachments(
		NewsAttachments newsAttachments) throws SystemException {
		return newsAttachmentsPersistence.remove(newsAttachments);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NewsAttachments.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return newsAttachmentsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return newsAttachmentsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NewsAttachments fetchNewsAttachments(long newsAttachmentId)
		throws SystemException {
		return newsAttachmentsPersistence.fetchByPrimaryKey(newsAttachmentId);
	}

	/**
	 * Returns the news attachments with the primary key.
	 *
	 * @param newsAttachmentId the primary key of the news attachments
	 ...
	 */
	@Override
	public NewsAttachments getNewsAttachments(long newsAttachmentId)
		throws PortalException, SystemException {
		return newsAttachmentsPersistence.findByPrimaryKey(newsAttachmentId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return newsAttachmentsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NewsAttachments> getNewsAttachmentses(int start, int end)
		throws SystemException {
		return newsAttachmentsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getNewsAttachmentsesCount() throws SystemException {
		return newsAttachmentsPersistence.countAll();
	}

	/**
	 * Updates the news attachments in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param newsAttachments the news attachments
	 * @return the news attachments that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NewsAttachments updateNewsAttachments(
		NewsAttachments newsAttachments) throws SystemException {
		return newsAttachmentsPersistence.update(newsAttachments);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.NewsAttachments",
			newsAttachmentsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.NewsAttachments");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = newsAttachmentsPersistence.getDataSource();
	...
	private NewsAttachmentsLocalServiceClpInvoker _clpInvoker = new NewsAttachmentsLocalServiceClpInvoker();
}
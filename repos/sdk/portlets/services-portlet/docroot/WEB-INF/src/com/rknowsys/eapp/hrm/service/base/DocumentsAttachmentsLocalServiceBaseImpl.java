...
import com.rknowsys.eapp.hrm.service.DocumentsAttachmentsLocalService;
...
/**
 * Provides the base implementation for the documents attachments local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.DocumentsAttachmentsLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.DocumentsAttachmentsLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.DocumentsAttachmentsLocalServiceUtil
 * @generated
 */
public abstract class DocumentsAttachmentsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DocumentsAttachmentsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.DocumentsAttachmentsLocalServiceUtil} to access the documents attachments local service.
	 */
	...
	@Override
	public DocumentsAttachments addDocumentsAttachments(
		DocumentsAttachments documentsAttachments) throws SystemException {
		documentsAttachments.setNew(true);

		return documentsAttachmentsPersistence.update(documentsAttachments);
	}
	 ...
	 */
	@Override
	public DocumentsAttachments createDocumentsAttachments(
		long documentAttachmentId) {
		return documentsAttachmentsPersistence.create(documentAttachmentId);
	}
	...
	@Override
	public DocumentsAttachments deleteDocumentsAttachments(
		long documentAttachmentId) throws PortalException, SystemException {
		return documentsAttachmentsPersistence.remove(documentAttachmentId);
	}
	...
	public DocumentsAttachments deleteDocumentsAttachments(
		DocumentsAttachments documentsAttachments) throws SystemException {
		return documentsAttachmentsPersistence.remove(documentsAttachments);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DocumentsAttachments.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return documentsAttachmentsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return documentsAttachmentsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DocumentsAttachments fetchDocumentsAttachments(
		long documentAttachmentId) throws SystemException {
		return documentsAttachmentsPersistence.fetchByPrimaryKey(documentAttachmentId);
	}
	 ...
	 */
	@Override
	public DocumentsAttachments getDocumentsAttachments(
		long documentAttachmentId) throws PortalException, SystemException {
		return documentsAttachmentsPersistence.findByPrimaryKey(documentAttachmentId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return documentsAttachmentsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DocumentsAttachments> getDocumentsAttachmentses(int start,
		int end) throws SystemException {
		return documentsAttachmentsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDocumentsAttachmentsesCount() throws SystemException {
		return documentsAttachmentsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DocumentsAttachments updateDocumentsAttachments(
		DocumentsAttachments documentsAttachments) throws SystemException {
		return documentsAttachmentsPersistence.update(documentsAttachments);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.DocumentsAttachments",
			documentsAttachmentsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.DocumentsAttachments");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = documentsAttachmentsPersistence.getDataSource();
	...
	private DocumentsAttachmentsLocalServiceClpInvoker _clpInvoker = new DocumentsAttachmentsLocalServiceClpInvoker();
}
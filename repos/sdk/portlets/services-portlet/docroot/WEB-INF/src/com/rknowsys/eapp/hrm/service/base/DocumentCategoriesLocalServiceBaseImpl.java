...
import com.rknowsys.eapp.hrm.service.DocumentCategoriesLocalService;
...
/**
 * Provides the base implementation for the document categories local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.DocumentCategoriesLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.DocumentCategoriesLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.DocumentCategoriesLocalServiceUtil
 * @generated
 */
public abstract class DocumentCategoriesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DocumentCategoriesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.DocumentCategoriesLocalServiceUtil} to access the document categories local service.
	 */
	...
	@Override
	public DocumentCategories addDocumentCategories(
		DocumentCategories documentCategories) throws SystemException {
		documentCategories.setNew(true);

		return documentCategoriesPersistence.update(documentCategories);
	}
	 ...
	 */
	@Override
	public DocumentCategories createDocumentCategories(long documentcategoryId) {
		return documentCategoriesPersistence.create(documentcategoryId);
	}
	...
	@Override
	public DocumentCategories deleteDocumentCategories(long documentcategoryId)
		throws PortalException, SystemException {
		return documentCategoriesPersistence.remove(documentcategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DocumentCategories deleteDocumentCategories(
		DocumentCategories documentCategories) throws SystemException {
		return documentCategoriesPersistence.remove(documentCategories);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DocumentCategories.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return documentCategoriesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return documentCategoriesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DocumentCategories fetchDocumentCategories(long documentcategoryId)
		throws SystemException {
		return documentCategoriesPersistence.fetchByPrimaryKey(documentcategoryId);
	}
	 ...
	 */
	@Override
	public DocumentCategories getDocumentCategories(long documentcategoryId)
		throws PortalException, SystemException {
		return documentCategoriesPersistence.findByPrimaryKey(documentcategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return documentCategoriesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DocumentCategories> getDocumentCategorieses(int start, int end)
		throws SystemException {
		return documentCategoriesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDocumentCategoriesesCount() throws SystemException {
		return documentCategoriesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DocumentCategories updateDocumentCategories(
		DocumentCategories documentCategories) throws SystemException {
		return documentCategoriesPersistence.update(documentCategories);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.DocumentCategories",
			documentCategoriesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.DocumentCategories");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = documentCategoriesPersistence.getDataSource();
	...
	private DocumentCategoriesLocalServiceClpInvoker _clpInvoker = new DocumentCategoriesLocalServiceClpInvoker();
}
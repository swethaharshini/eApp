...
import com.rknowsys.eapp.hrm.service.LeaveAccrualLocalService;
...
/**
 * Provides the base implementation for the leave accrual local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.LeaveAccrualLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.LeaveAccrualLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.LeaveAccrualLocalServiceUtil
 * @generated
 */
public abstract class LeaveAccrualLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LeaveAccrualLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.LeaveAccrualLocalServiceUtil} to access the leave accrual local service.
	 */
	...
	@Override
	public LeaveAccrual addLeaveAccrual(LeaveAccrual leaveAccrual)
		throws SystemException {
		leaveAccrual.setNew(true);

		return leaveAccrualPersistence.update(leaveAccrual);
	}
	 ...
	 */
	@Override
	public LeaveAccrual createLeaveAccrual(long leaveAccrualId) {
		return leaveAccrualPersistence.create(leaveAccrualId);
	}
	...
	@Override
	public LeaveAccrual deleteLeaveAccrual(long leaveAccrualId)
		throws PortalException, SystemException {
		return leaveAccrualPersistence.remove(leaveAccrualId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveAccrual deleteLeaveAccrual(LeaveAccrual leaveAccrual)
		throws SystemException {
		return leaveAccrualPersistence.remove(leaveAccrual);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveAccrual.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return leaveAccrualPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return leaveAccrualPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LeaveAccrual fetchLeaveAccrual(long leaveAccrualId)
		throws SystemException {
		return leaveAccrualPersistence.fetchByPrimaryKey(leaveAccrualId);
	}
	 ...
	 */
	@Override
	public LeaveAccrual getLeaveAccrual(long leaveAccrualId)
		throws PortalException, SystemException {
		return leaveAccrualPersistence.findByPrimaryKey(leaveAccrualId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return leaveAccrualPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveAccrual> getLeaveAccruals(int start, int end)
		throws SystemException {
		return leaveAccrualPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLeaveAccrualsCount() throws SystemException {
		return leaveAccrualPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveAccrual updateLeaveAccrual(LeaveAccrual leaveAccrual)
		throws SystemException {
		return leaveAccrualPersistence.update(leaveAccrual);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.LeaveAccrual",
			leaveAccrualLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = leaveAccrualPersistence.getDataSource();
	...
	private LeaveAccrualLocalServiceClpInvoker _clpInvoker = new LeaveAccrualLocalServiceClpInvoker();
}
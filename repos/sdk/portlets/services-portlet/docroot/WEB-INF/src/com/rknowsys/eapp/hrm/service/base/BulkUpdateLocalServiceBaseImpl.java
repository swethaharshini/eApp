...
import com.rknowsys.eapp.hrm.service.BulkUpdateLocalService;
import com.rknowsys.eapp.hrm.service.persistence.BulkUpdateFinder;
import com.rknowsys.eapp.hrm.service.persistence.BulkUpdatePersistence;
...
/**
 * Provides the base implementation for the bulk update local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.BulkUpdateLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.BulkUpdateLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.BulkUpdateLocalServiceUtil
 * @generated
 */
public abstract class BulkUpdateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BulkUpdateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.BulkUpdateLocalServiceUtil} to access the bulk update local service.
	 */
	...
	@Override
	public BulkUpdate addBulkUpdate(BulkUpdate bulkUpdate)
		throws SystemException {
		bulkUpdate.setNew(true);

		return bulkUpdatePersistence.update(bulkUpdate);
	}
	 ...
	 */
	@Override
	public BulkUpdate createBulkUpdate(long bulkupdateId) {
		return bulkUpdatePersistence.create(bulkupdateId);
	}
	...
	@Override
	public BulkUpdate deleteBulkUpdate(long bulkupdateId)
		throws PortalException, SystemException {
		return bulkUpdatePersistence.remove(bulkupdateId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BulkUpdate deleteBulkUpdate(BulkUpdate bulkUpdate)
		throws SystemException {
		return bulkUpdatePersistence.remove(bulkUpdate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BulkUpdate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return bulkUpdatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return bulkUpdatePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bulkUpdatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BulkUpdate fetchBulkUpdate(long bulkupdateId)
		throws SystemException {
		return bulkUpdatePersistence.fetchByPrimaryKey(bulkupdateId);
	}
	 ...
	 */
	@Override
	public BulkUpdate getBulkUpdate(long bulkupdateId)
		throws PortalException, SystemException {
		return bulkUpdatePersistence.findByPrimaryKey(bulkupdateId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bulkUpdatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BulkUpdate> getBulkUpdates(int start, int end)
		throws SystemException {
		return bulkUpdatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBulkUpdatesCount() throws SystemException {
		return bulkUpdatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BulkUpdate updateBulkUpdate(BulkUpdate bulkUpdate)
		throws SystemException {
		return bulkUpdatePersistence.update(bulkUpdate);
	}

	/**
	 * Returns the bulk update local service.
	 *
	 * @return the bulk update local service
	 */
	public com.rknowsys.eapp.hrm.service.BulkUpdateLocalService getBulkUpdateLocalService() {
		return bulkUpdateLocalService;
	}

	/**
	 * Sets the bulk update local service.
	 *
	 * @param bulkUpdateLocalService the bulk update local service
	 */
	public void setBulkUpdateLocalService(
		com.rknowsys.eapp.hrm.service.BulkUpdateLocalService bulkUpdateLocalService) {
		this.bulkUpdateLocalService = bulkUpdateLocalService;
	}

	/**
	 * Returns the bulk update persistence.
	 *
	 * @return the bulk update persistence
	 */
	public BulkUpdatePersistence getBulkUpdatePersistence() {
		return bulkUpdatePersistence;
	}

	/**
	 * Sets the bulk update persistence.
	 *
	 * @param bulkUpdatePersistence the bulk update persistence
	 */
	public void setBulkUpdatePersistence(
		BulkUpdatePersistence bulkUpdatePersistence) {
		this.bulkUpdatePersistence = bulkUpdatePersistence;
	}

	/**
	 * Returns the bulk update finder.
	 *
	 * @return the bulk update finder
	 */
	public BulkUpdateFinder getBulkUpdateFinder() {
		return bulkUpdateFinder;
	}

	/**
	 * Sets the bulk update finder.
	 *
	 * @param bulkUpdateFinder the bulk update finder
	 */
	public void setBulkUpdateFinder(BulkUpdateFinder bulkUpdateFinder) {
		this.bulkUpdateFinder = bulkUpdateFinder;
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.BulkUpdate",
			bulkUpdateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bulkUpdatePersistence.getDataSource();
	...
	@BeanReference(type = com.rknowsys.eapp.hrm.service.BulkUpdateLocalService.class)
	protected com.rknowsys.eapp.hrm.service.BulkUpdateLocalService bulkUpdateLocalService;
	@BeanReference(type = BulkUpdatePersistence.class)
	protected BulkUpdatePersistence bulkUpdatePersistence;
	@BeanReference(type = BulkUpdateFinder.class)
	protected BulkUpdateFinder bulkUpdateFinder;
	...
	private BulkUpdateLocalServiceClpInvoker _clpInvoker = new BulkUpdateLocalServiceClpInvoker();
}
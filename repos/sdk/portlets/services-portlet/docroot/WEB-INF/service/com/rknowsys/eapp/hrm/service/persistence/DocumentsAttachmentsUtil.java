...
/**
 * The persistence utility for the documents attachments service. This utility wraps {@link DocumentsAttachmentsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see DocumentsAttachmentsPersistenceImpl
 * @generated
 */
public class DocumentsAttachmentsUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(DocumentsAttachments documentsAttachments) {
		getPersistence().clearCache(documentsAttachments);
	}
	 ...
	 */
	public static List<DocumentsAttachments> findWithDynamicQuery(
	 ...
	 */
	public static DocumentsAttachments update(
		DocumentsAttachments documentsAttachments) throws SystemException {
		return getPersistence().update(documentsAttachments);
	}
	 ...
	 */
	public static DocumentsAttachments update(
		DocumentsAttachments documentsAttachments, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(documentsAttachments, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(documentsAttachments);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.rknowsys.eapp.hrm.model.DocumentsAttachments> documentsAttachmentses) {
		getPersistence().cacheResult(documentsAttachmentses);
	}
	...
	*/
	public static com.rknowsys.eapp.hrm.model.DocumentsAttachments create(
		long documentAttachmentId) {
		return getPersistence().create(documentAttachmentId);
	}
	...
	*/
	public static com.rknowsys.eapp.hrm.model.DocumentsAttachments remove(
		long documentAttachmentId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rknowsys.eapp.hrm.NoSuchDocumentsAttachmentsException {
		return getPersistence().remove(documentAttachmentId);
	}

	public static com.rknowsys.eapp.hrm.model.DocumentsAttachments updateImpl(
		com.rknowsys.eapp.hrm.model.DocumentsAttachments documentsAttachments)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(documentsAttachments);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rknowsys.eapp.hrm.model.DocumentsAttachments findByPrimaryKey(
		long documentAttachmentId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rknowsys.eapp.hrm.NoSuchDocumentsAttachmentsException {
		return getPersistence().findByPrimaryKey(documentAttachmentId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rknowsys.eapp.hrm.model.DocumentsAttachments fetchByPrimaryKey(
		long documentAttachmentId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(documentAttachmentId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.rknowsys.eapp.hrm.model.DocumentsAttachments> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static DocumentsAttachmentsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (DocumentsAttachmentsPersistence)PortletBeanLocatorUtil.locate(com.rknowsys.eapp.hrm.service.ClpSerializer.getServletContextName(),
					DocumentsAttachmentsPersistence.class.getName());

			ReferenceRegistry.registerReference(DocumentsAttachmentsUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(DocumentsAttachmentsPersistence persistence) {
	}

	private static DocumentsAttachmentsPersistence _persistence;
}
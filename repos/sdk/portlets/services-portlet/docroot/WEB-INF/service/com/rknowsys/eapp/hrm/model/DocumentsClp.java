 ...
 * @author rknowsys
 */
public class DocumentsClp extends BaseModelImpl<Documents> implements Documents {
	public DocumentsClp() {
	}
	...
	public void setDocumentId(long documentId) {
		...
		if (_documentsRemoteModel != null) {
			try {
				Class<?> clazz = _documentsRemoteModel.getClass();

				Method method = clazz.getMethod("setDocumentId", long.class);

				method.invoke(_documentsRemoteModel, documentId);
			}
			catch (Exception e) {
	...
	public void setCompanyId(long companyId) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, companyId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setGroupId(long groupId) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, groupId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreateDate(Date createDate) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, createDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserId(long userId) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, userId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTopic(String topic) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, topic);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCategory(String category) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, category);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setDescription(String description) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, description);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPublishDate(Date publishDate) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, publishDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStatus(boolean status) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, status);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setAdmin(boolean admin) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, admin);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSupervisor(boolean supervisor) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, supervisor);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setAllEmployees(boolean allEmployees) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, allEmployees);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPublishedTo(String publishedTo) {
		...
		if (_documentsRemoteModel != null) {
			try {
				...
				method.invoke(_documentsRemoteModel, publishedTo);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDocumentsRemoteModel() {
		return _documentsRemoteModel;
	}

	public void setDocumentsRemoteModel(BaseModel<?> documentsRemoteModel) {
		_documentsRemoteModel = documentsRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _documentsRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_documentsRemoteModel,
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			DocumentsLocalServiceUtil.addDocuments(this);
		}
		else {
			DocumentsLocalServiceUtil.updateDocuments(this);
		}
	}

	@Override
	public Documents toEscapedModel() {
		return (Documents)ProxyUtil.newProxyInstance(Documents.class.getClassLoader(),
			new Class[] { Documents.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		DocumentsClp clone = new DocumentsClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DocumentsClp)) {
			return false;
		}

		DocumentsClp documents = (DocumentsClp)obj;
	...
	private BaseModel<?> _documentsRemoteModel;
}
...
/**
 * Provides the local service interface for LeaveAccrual. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author rknowsys
 * @see LeaveAccrualLocalServiceUtil
...
public interface LeaveAccrualLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LeaveAccrualLocalServiceUtil} to access the leave accrual local service. Add custom service methods to {@link com.rknowsys.eapp.hrm.service.impl.LeaveAccrualLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

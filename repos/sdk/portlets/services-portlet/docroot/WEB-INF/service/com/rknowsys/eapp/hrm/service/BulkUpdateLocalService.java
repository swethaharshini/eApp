...
/**
 * Provides the local service interface for BulkUpdate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author rknowsys
 * @see BulkUpdateLocalServiceUtil
...
public interface BulkUpdateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BulkUpdateLocalServiceUtil} to access the bulk update local service. Add custom service methods to {@link com.rknowsys.eapp.hrm.service.impl.BulkUpdateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
/**
 * Provides the local service interface for Documents. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author rknowsys
 * @see DocumentsLocalServiceUtil
...
public interface DocumentsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DocumentsLocalServiceUtil} to access the documents local service. Add custom service methods to {@link com.rknowsys.eapp.hrm.service.impl.DocumentsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
<liferay-ui:search-container 
	...
	<liferay-ui:search-container-row className="NewsAttachments"
		...
		<liferay-ui:search-container-column-text name="File Name" property="fileName" href='<%=themeDisplay.getPortalURL()+"/c/document_library/get_file?uuid="+NewsAttachments.getUuid()+"&groupId="+themeDisplay.getScopeGroupId() %>'/>
